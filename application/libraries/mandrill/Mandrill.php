...
class Mandrill {
    ...
    public $apikey;
    public $ch;
    public $root = 'https://mandrillapp.com/api/3.0';
    public $debug = false;
    ...
    public function __construct($apikey=null) {
        //email = site@hardosoloplast.com / S1t32014
        //password = MANDRILL2014
        //if(!$apikey) $apikey = 'RaBN6SsuVKC5V4A5UQnUGw';
        if(!$apikey) $apikey = '6aa6ef088b6dc7507b0928231b4b1e31-us4';
        //echo $apikey;
