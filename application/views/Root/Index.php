<?php
    ...
    if($user_id != ''){
        echo "<script>location.replace('".base_url()."Root/Home/Dashboard');</script>";  
    }
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
        ...
        <link rel="stylesheet" href="<?php echo base_url();?>Assets/root/css/matrix-login.css" />
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" action="index.html">
				 <div class="control-group normal_text"> <h3><img src="<?php echo base_url();?>Assets/root/img/logo.png" alt="Logo"/></h3></div>
        ...
        <script src="<?php echo base_url();?>Assets/root/js/jquery.min.js"></script>  
        <script src="<?php echo base_url();?>Assets/root/js/matrix.login.js"></script> 
    </body>
            ...
            $.ajax({
                ...
                success:function (response) {
                    if(response.success == true){
                        location.replace("<?=base_url()?>Root/Home/Dashboard")
                    }
                    else{
